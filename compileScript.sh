...
docker exec spark-master bash -c "./spark/bin/spark-submit --class "HashtagsCountingLocalApp" --master local[*] /tmp/twitter-hashtags.jar /datalake/11-07-16/ /datawarehouse/results/"